...
ActiveRecord::Schema.define(version: 20150331130746) do
  ...
  create_table "comment_of_comments", force: true do |t|
    t.string   "content"
  ...
  add_index "comment_of_comments", ["comment_id"], name: "index_comment_of_comments_on_comment_id", using: :btree

  create_table "comments", force: true do |t|
    t.string   "comment"
    t.integer  "user_id"
    t.string   "user_name"
    t.integer  "image_date_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "hsh"
  end
  ...
  create_table "socnets", force: true do |t|
    t.string   "network"
    t.integer  "user_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "socnets", ["user_id"], name: "index_socnets_on_user_id", using: :btree
